...
class RoomValidatorUnitTest extends BaseUnitTest {
    ...
    void testValidateWhenRoomNameIsMissing() {
        ...
        assertEquals(new ValidationError(ROOM_NAME, ROOM_NAME + MISSING), exception.getValidationErros().getError(0));
    }
    ...
    void testValidateWhenRoomSeatsAreMissing() {
        ...
        assertEquals(1, exception.getValidationErros().getNumberOfErrors());
        assertEquals(new ValidationError(ROOM_SEATS, ROOM_SEATS + MISSING), exception.getValidationErros().getError(0));
    }
    ...
    void testValidateWhenRoomNameIsDuplicate() {
        ...
        assertEquals(1, exception.getValidationErros().getNumberOfErrors());
        assertEquals(new ValidationError(ROOM_NAME, ROOM_NAME + DUPLICATE), exception.getValidationErros().getError(0));
    }
}
