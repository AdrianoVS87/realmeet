...
public class PageUtilsUnitTest extends BaseUnitTest {
    ...
    void testNewPageableWhenPageIsNegative() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> newPageable(-1, null, 10, null, SORTABLE_FIELDS));
    }

    @Test
    void testNewPageableWhenLimitIsInvalid() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> newPageable(null, 0, 10, null, SORTABLE_FIELDS));
    }
    ...
    void testNewPageableWhenOrderByIsNull() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> newPageable(null, 0, 10, null, null));
    }

    @Test
    void testNewPageableWhenOrderByIsEmpty() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> newPageable(null, 0, 10, null, emptyList()));
    }
